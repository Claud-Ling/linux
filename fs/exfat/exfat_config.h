...
# define EXFAT_CONFIG_DEBUG_MSG		1
#else
# define EXFAT_CONFIG_DEBUG_MSG		0
#endif
#ifdef CONFIG_EXFAT_DELAYED_SYNC
# define EXFAT_CONFIG_DELAYED_SYNC	1
#else
# define EXFAT_CONFIG_DELAYED_SYNC	0
#endif
#define EXFAT_CONFIG_DEFAULT_CODEPAGE	CONFIG_EXFAT_DEFAULT_CODEPAGE
#define EXFAT_CONFIG_DEFAULT_IOCHARSET	CONFIG_EXFAT_DEFAULT_IOCHARSET
