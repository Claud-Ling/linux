#ifndef __ARCH_SIGMA_DTV_PROC_FUSE_H__
#define __ARCH_SIGMA_DTV_PROC_FUSE_H__
...
#define GET_MACRO(x,_1,_2,_3,_4,_5,_6,_7,_8,_9,_10,_11,_12,_13,		\
		    _14,_15,_16,_17,_18,_19,_20,_21,_22,_23,_24,	\
		    _25,_26,_27,_28,_29,_30,_31,_32, NAME,...) NAME

/*
 * macro FOR_EACH(action, ...) is use to iter each variable in __VA_ARGS__ list (32 args at most)
 * for example:
 * FOR_EACH(action, 1,2) ===> action(1) action(2)
 * FOR_EACH(action, 1,2,3,4,5) ===> action(1) action(2) action(3) action(4) action(5)
 *
 */
#define FOR_EACH(action,...) \
GET_MACRO(,##__VA_ARGS__,FE_32,FE_31,FE_30,FE_29,FE_28,FE_27,FE_26,FE_25,	\
...
#define FIELD(n) n
#define DECLARE_EACH_FIELDS(...) FOR_EACH(FIELD,##__VA_ARGS__)

#define otp_fuse_field(s, l, fn)        \
fn {                                    \
        field-offset=<s>;               \
        field-width=<l>;                \
};
...
#endif /* __ARCH_SIGMA_DTV_PROC_FUSE_H__ */
