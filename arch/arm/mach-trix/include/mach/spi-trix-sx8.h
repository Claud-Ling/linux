...
#define TRIHIDTV_HBR_MIF_INTERRUPT                    (TRIHIDTV_EIC_IRQ_BASE + 4 )
#define TRIHIDTV_V_LOGO_INTERRUPT                     (TRIHIDTV_EIC_IRQ_BASE + 5 )
#define TRIHIDTV_V_FRCA_INTERRUPT_1                   (TRIHIDTV_EIC_IRQ_BASE + 6 )
#define TRIHIDTV_V_FRCA_INTERRUPT_2                   (TRIHIDTV_EIC_IRQ_BASE + 7 )
#define TRIHIDTV_V_FRCB_A_INTERRUPT                   (TRIHIDTV_EIC_IRQ_BASE + 8 )
#define TRIHIDTV_V_FRCB_B_INTERRUPT                   (TRIHIDTV_EIC_IRQ_BASE + 9 )
#define TRIHIDTV_V_METER_INTERRUPT                    (TRIHIDTV_EIC_IRQ_BASE + 10)

#define TRIHIDTV_GE3D_IMG_INTERRUPT                   (TRIHIDTV_EIC_IRQ_BASE + 11)
...
#define TRIHIDTV_SDIO_1_INTERRUPT                     (TRIHIDTV_EIC_IRQ_BASE + 27)
...
#define TRIHIDTV_V_INCAP_3_INTERRUPT                  (TRIHIDTV_EIC_IRQ_BASE + 60)
#define TRIHIDTV_V_INCAP_4_INTERRUPT                  (TRIHIDTV_EIC_IRQ_BASE + 61)
#define TRIHIDTV_V_INCAP_5_INTERRUPT                  (TRIHIDTV_EIC_IRQ_BASE + 62)
...
#define TRIHIDTV_MVED_GIC_INTERRUPT                   (TRIHIDTV_EIC_IRQ_BASE + 67)
...
#define TRIHIDTV_VDMA_W_INTERRUPT                     (TRIHIDTV_EIC_IRQ_BASE + 73)
...
#define TRIHIDTV_V_DEITN_INTERRUPT                    (TRIHIDTV_EIC_IRQ_BASE + 77)
#define TRIHIDTV_V_SCALAR_INTERRUPT                   (TRIHIDTV_EIC_IRQ_BASE + 78)
#define TRIHIDTV_V_NR_INTERRUPT                       (TRIHIDTV_EIC_IRQ_BASE + 79)
#define TRIHIDTV_V_INCAP_1_INTERRUPT                  (TRIHIDTV_EIC_IRQ_BASE + 80)
#define TRIHIDTV_V_PANEL_INTERRUPT                    (TRIHIDTV_EIC_IRQ_BASE + 81)

#define TRIHIDTV_V_EDR_INTERRUPT                      (TRIHIDTV_EIC_IRQ_BASE + 82)
#define TRIHIDTV_HDMI_RX_INTERRUPT                    (TRIHIDTV_EIC_IRQ_BASE + 83)
...
#define TRIHIDTV_V_PANEL_NEW_INTERRUPT                (TRIHIDTV_EIC_IRQ_BASE + 88)
#define TRIHIDTV_V_INCAP_2_INTERRUPT                  (TRIHIDTV_EIC_IRQ_BASE + 89)
...
#define TRIHIDTV_WINDSOR_INTERRUPT_1                  (TRIHIDTV_EIC_IRQ_BASE + 94)
#define TRIHIDTV_WINDSOR_INTERRUPT_2                  (TRIHIDTV_EIC_IRQ_BASE + 95)
...
#define TRIHIDTV_CIP_MSP_TSA_INTERRUPT                (TRIHIDTV_EIC_IRQ_BASE + 114)
#define TRIHIDTV_CIP_MSP_MCX_INTERRUPT                (TRIHIDTV_EIC_IRQ_BASE + 115)
#define TRIHIDTV_CIP_MSP_TSP_INTERRUPT                (TRIHIDTV_EIC_IRQ_BASE + 116)
#define TRIHIDTV_CIP_MSP_TSR_INTERRUPT                (TRIHIDTV_EIC_IRQ_BASE + 117)
#define TRIHIDTV_CIP_MSP_TSX_INTERRUPT                (TRIHIDTV_EIC_IRQ_BASE + 118)
#define TRIHIDTV_CIP_MSP_VD0_INTERRUPT                (TRIHIDTV_EIC_IRQ_BASE + 119)
#define TRIHIDTV_CIP_MSP_VD1_INTERRUPT                (TRIHIDTV_EIC_IRQ_BASE + 120)
#define TRIHIDTV_CIP_MSP_IPC_INTERRUPT                (TRIHIDTV_EIC_IRQ_BASE + 121)

#define TRIHIDTV_PLF_SEC_TIMER_INTERRUPT              (TRIHIDTV_EIC_IRQ_BASE + 122)

#define TRIHIDTV_RESERVED_IRQ                         (TRIHIDTV_EIC_IRQ_BASE + 123)
