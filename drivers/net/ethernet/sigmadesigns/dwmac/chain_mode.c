/*******************************************************************************
  ...
  Copyright(C) 2011  DWicroelectronics Ltd
...
static void dwmac_init_dma_chain(void *des, dma_addr_t phy_addr,
...
const struct dwmac_mode_ops chain_mode_ops = {
	.init = dwmac_init_dma_chain,
