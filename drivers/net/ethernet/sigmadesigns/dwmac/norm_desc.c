...
static int ndesc_get_tx_status(void *data, struct dwmac_extra_stats *x,
...
static int ndesc_get_rx_status(void *data, struct dwmac_extra_stats *x,
			       struct dma_desc *p)
{
	int ret = good_frame;
				  ...
				  bool ls_ic)
{
	...
	p->des1 = tdes1;
	desc_coherence_check(&p->des1, tdes1);
...
const struct dwmac_desc_ops ndesc_ops = {
