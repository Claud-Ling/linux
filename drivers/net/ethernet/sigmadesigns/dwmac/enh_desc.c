...
static int enh_desc_get_tx_status(void *data, struct dwmac_extra_stats *x,
...
static void enh_desc_get_ext_status(void *data, struct dwmac_extra_stats *x,
...
static int enh_desc_get_rx_status(void *data, struct dwmac_extra_stats *x,
				  struct dma_desc *p)
{
	struct net_device_stats *stats = (struct net_device_stats *)data;
...
{
	return (le32_to_cpu(p->des0) & RDES0_OWN) >> 31;
}
				     ...
				     bool ls_ic)
{
	...
	desc_coherence_check(&p->des0, tdes0);
...
static int enh_desc_get_rx_frame_len(struct dma_desc *p, int rx_coe_type)
{
	 ...
	 * engines. */
	if (rx_coe_type == DWMAC_RX_COE_TYPE1)
		csum = 2;
...
const struct dwmac_desc_ops enh_desc_ops = {
