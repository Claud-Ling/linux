...
int klib_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
    int ret = 0;
    mm_segment_t oldfs;
...
EXPORT_SYMBOL_GPL(klib_fopen); 
EXPORT_SYMBOL_GPL(klib_fclose); 
EXPORT_SYMBOL_GPL(klib_fseek); 
EXPORT_SYMBOL_GPL(klib_fread); 
EXPORT_SYMBOL_GPL(klib_fwrite); 
